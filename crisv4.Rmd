...
myvars<-c("typehs", "gender", "act", "gpa", "age", "video", "religion", "paeduc", "year", "party", "sport", "tv", "race", "weight", "income", "race2")
dta<-dta[myvars]
...
```{r}
ivreg3 <- ivreg(log(act) ~ video + age+ gender+ (gpa^2)+ religion +party+race2+ income |age+ gender+ (gpa^2)+ religion +party+race2+ income+ year, data = dta)
